...
public class GradeSystem {
	...
	/**
	 * --------------------------------------------------------------------- 1.
	 * 開檔 input file 2. 用Java LinkedList建構an empty list of grades叫 aList 3. read
	 * token 4. while not endOfFile 1.call Grade() 建構aGrade 2.用 Java Scanner 來
	 * scan line 把data存入aGrade 3. aGrade.calculateTotalGrade(weights) 4. 把
	 * aGrade 存入 aList 5. if endOfLine then read line end if end while
	 * ----------
	 * ----------------------------------------------------------------
	 */
	GradeSystem() {
		...
		try {
			...
			while (scanner.hasNextLine()) {
				aGrade = new Grade(scanner.next(), scanner.next(),
	 ...
	 * @throws
	 * 
	 * Time estimate : Example:當被呼叫時在螢幕秀出ID的每一項分數和權重算完的總成績
	 * -------------------------------------------------------------------------
	 */
	/**
	 * ---------------------------------------------------------------------
	 ...
	 * @throws
	 * 
	 * Time estimate : Example:當被呼叫時在螢幕秀出ID的排名
	 * -------------------------------------------------------------------------
	 */
	/**
	 * --------------------------------------------------------------------- 1.
	 * 取得這 ID 的 totalGrade 2. 令rank 為 1 3. loop aGrade in aList if aTotalGrade >
	 * theTotalGrade then increment rank end loop 4. print rank
	 * ------------------
	 * --------------------------------------------------------
	 */
	 ...
	 * @throws
	 * 
	 * Time estimate : Example:螢幕顯示舊配分比例， 在螢幕輸入新配分比例， 顯示確認新配分比例。
	 * -------------------------------------------------------------------------
	 */
	/**
	 * --------------------------------------------------------------------- 1.
	 * showOldWeights() 2. getNewWeights() 3. showConfirmNewWeights() 4.
	 * setWeights(weights) 5. loop aGrade in aList to
	 * calculateTotalGrade(weights) end loop
	 * ------------------------------------
	 * --------------------------------------
	 */
	 ...
	 * @throws
	 * 
	 * Time estimate : Example:螢幕顯示原始的成績，並且依序詢問是否修改並修改之，最後寫回檔案。
	 * -------------------------------------------------------------------------
	 */
	/**
	 * ---------------------------------------------------------------------
